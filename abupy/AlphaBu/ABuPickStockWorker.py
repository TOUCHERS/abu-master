...
from ..TradeBu import AbuKLManager, AbuCapital, AbuBenchmark
...
class AbuPickStockWorker(AbuPickStockWorkBase):
    ...
    def __init__(self, capital:AbuCapital, benchmark:AbuBenchmark, kl_pd_manager:AbuKLManager, choice_symbols:list[str]=None, stock_pickers:list=None):
        """
